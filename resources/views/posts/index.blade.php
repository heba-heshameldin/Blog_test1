<x-layout>
    <div class="page" style="margin-top:40px; margin-left:40px; margin-right:40px">
        ...
        @csrf
        <select onchange="location = '/posts/category/' + this.value;" name="category"
            class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style="margin-top:5px">
        ...
        <button type="button" class="btn btn-primary"
            style="margin-bottom: 20px ;  margin-top:17px; position:relative:right"><a
                href="{{ route('posts.create') }}" style="color: white; text-decoration: none ; "> ➕ Add new
                post</a></button>
        {{-- @else
            <button type="button" class="btn btn-primary"
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="card card-cascade card-ecommerce wider shadow mb-5  ">
                        <div class="view view-cascade overlay text-center"> <img class="card-img-top"
                                src="{{ URL::to('/storage/posts') . '/' . $post->thumbnail }}" alt=""
                                style="height: 300px">
                            <a>
                        ...
                        <div class="card-body card-body-cascade">
                            ...
                            <div>
                                ...
                                {{-- /{{ $posts->id }} --}}
                                {{-- <button type="button" class="btn btn-danger" style="margin-bottom: 20px"><a
